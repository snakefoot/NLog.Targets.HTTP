...
> ⚠️ This project will be heading towards becoming an archive.

> ℹ️ Alternative [NLog.Targets.HttpClient](https://www.nuget.org/packages/NLog.Targets.HttpClient/) for sending log messages to HTTP or HTTPS endpoint, with support for batching and compression.
